...
THRESHOLD_COUNT = 3  # Number of consecutive checks before sending an alert
...
while True:
    ...
    # Check if Freezer is above 17°F for 3 consecutive checks
    if temp_f_1 > 17:
    ...
    # Check if Fridge is above 40°F for 3 consecutive checks
    if temp_f_2 > 40:
    ...
    if fridge_above_40_count >= THRESHOLD_COUNT:
        try:
            message_2 = (
                f"ALERT: {SENSOR_LOCATION_NAME_2} Temperature above 40°F for {fridge_above_40_count} checks!\n"
